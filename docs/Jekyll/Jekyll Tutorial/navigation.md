...
Although there's already information about [interacting with data files]({% link docs/Jekyll/Jekyll Home/Jekyll_docs/datafiles.md %}) in other Jekyll docs, this tutorial dives into building more robust navigation for your site.
