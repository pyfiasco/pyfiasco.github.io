...
<!--
[Generators](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/generators/) create content on your site.
For example:
-->
[생성기](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/generators/)는 사이트의 내용을 생성합니다.
예시:
...
<!--
[Converters](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/converters/) change a markup language into another
format. For example:
-->
[변환기](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/converters/)는 마크업 언어를 다른 형식으로 변환합니다.
예시:
...
<!--
[Commands](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/commands/) extend the `jekyll` executable with
subcommands. For example:
-->
[명령어](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/commands/)는 `jekyll` 실행 파일의 기능을 하위 명령어
형태로 확장합니다. 예:
...
<!--
[Tags](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/tags/) create custom Liquid tags. For example:
-->
[태그](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/tags/)는 사용자 Liquid 태그를 생성합니다. 예:
...
<!--
[Filters](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/filters/) create custom Liquid filters. For example:
-->
[필터](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/filters/)는 사용자 Liquid 필터를 생성합니다. 예:
...
<!--
[Hooks](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/hooks/) give fine-grained control to extend the build
process.
-->
[훅](/docs/Jekyll/Jekyll Home/Jekyll_docs/plugins/hooks/)은 사이트 생성 절차를 세밀하게 통제할 수 있게
해줍니다.
...
플러그인에 [젬](/docs/Jekyll/Jekyll Home/start/)을 사용할 것을 권장합니다. 젬은
